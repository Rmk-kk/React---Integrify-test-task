...
const FavouriteStar = ({addToFavourites, id}) => {
    return (
            <>
                <svg onClick={() => addToFavourites(id, 'selected')} className="favourites-star" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 243.317 243.317" style={{'enableBackground':'new 0 0 243.317 243.317'}} xmlSpace="preserve">
